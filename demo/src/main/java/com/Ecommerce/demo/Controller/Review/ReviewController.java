...
public class ReviewController {
    ...
    @PutMapping("/editReview/{customer_id}/{product_id}/{review_id}")
    public ResponseEntity<?> editReview(
            @PathVariable final Long customer_id,
            @PathVariable final Long product_id,
            @PathVariable final Long review_id,
            @RequestBody  final ReviewDTO reviewDTO) {
        return this.reviewService.editReview(customer_id,product_id,review_id,reviewDTO);
    }

    @DeleteMapping("/removeReview/{customer_id}/{product_id}/{review_id}")
    public ResponseEntity<?> removeReview(
            @PathVariable final Long customer_id,
            @PathVariable final Long product_id,
            @PathVariable final Long review_id) {
        return this.reviewService.deleteReview(customer_id,product_id,review_id);
    }
